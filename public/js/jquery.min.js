  ...
  m.extend({
    clone: function(a, b, c) {
      ...
      if (
        ...
        for (d = ub(f), h = ub(a), g = 0; (e = h[g]) != null; ++g)
          d[g] && Bb(e, d[g])
      if (b)
        if (c)
          for (h = h || ub(a), d = d || ub(f), g = 0; (e = h[g]) != null; g++)
            Ab(e, d[g])
        else Ab(a, f)
      return (
        (d = ub(f, 'script')),
    ...
    m.fn.extend({
      ...
      domManip: function(a, b) {
        ...
        if (
          q ||
          (l > 1 && typeof p === 'string' && !k.checkClone && nb.test(p))
        )
  ...
  const ec = {
    '*': [
      function(a, b) {
        ...
        let g =
          (m.cssNumber[a] || (f !== 'px' && +d)) && bc.exec(m.css(c.elem, a))
        let h = 1
        let i = 20
        if (g && g[3] !== f) {
          ;(f = f || g[3]), (e = e || []), (g = +d || 1)
