...
(async () => {
  ...
  try {
    ...
    await page.type('input[name="password"]', '989898981223478910');
    await page.type('input[name="password_confirmed"]', '989898981223478910');
    // Select country (US)
    ...
    await page.type('#add_new_user_form input[name="password_one"]', '989898981223478910');
    await page.type('#add_new_user_form input[name="password_confirm"]', '989898981223478910');
    ...
    console.log('✅ Puppeteer add_new_user test passed!');
  } catch (err) {
