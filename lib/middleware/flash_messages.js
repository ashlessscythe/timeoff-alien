...
module.exports = function () {
  return function (req, res, next) {
    ...
    // messages.
    function install_flash_array(key) {
    ...
    req.session.flash_error = install_flash_array('errors').bind(req.session)
    req.session.flash_message = install_flash_array('messages').bind(req.session)
