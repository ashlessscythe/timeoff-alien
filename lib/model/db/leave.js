              ...
              return user
                ...
                .then(overlapping_leaves => {
                  if (overlapping_leaves.length > 0) {
                    ...
                    const can_coexist = overlapping_leaves.some(
                      overlapping_leave => {
                        ...
                        const leave_request = {
                          ...
                          does_fit_with_leave_day_at_start: function(
                            leave_day
                          ) {
                            return this._does_fit_with_point(
                              leave_day,
                              'from_date'
                            )
                          },
                        ...
                        return overlapping_leave.fit_with_leave_request(
                          leave_request
                        )
                      }
                    )
