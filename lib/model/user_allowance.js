...
class UserAllowance {
  ...
  get total_personal_available() {
    ...
    return Math.max(0, this._nominal_personal + this._personal_adjustment - personal_taken)
  }
  ...
  get number_of_days_available_in_allowance() {
    ...
    // Calculate the available allowance, but ensure it never goes below zero
    // This prevents negative balances when users are deactivated
