...
function LeaveDay(args) {
  ...
  _.each(['date', 'day_part', 'leave_type_id'], property => {
...
// Constants for leave day parts
LeaveDay.LEAVE_DAY_PART_ALL = 1
LeaveDay.LEAVE_DAY_PART_MORNING = 2
LeaveDay.LEAVE_DAY_PART_AFTERNOON = 3

LeaveDay.prototype.is_all_day_leave = function () {
  return String(this.day_part) === String(LeaveDay.LEAVE_DAY_PART_ALL)
}

LeaveDay.prototype.is_morning_leave = function () {
  return String(this.day_part) === String(LeaveDay.LEAVE_DAY_PART_MORNING)
}

LeaveDay.prototype.is_afternoon_leave = function () {
  return String(this.day_part) === String(LeaveDay.LEAVE_DAY_PART_AFTERNOON)
}
