...
LeaveDay.prototype.is_all_day_leave = function() {
  return String(this.day_part) === String(leaveConstants.leave_day_part_all())
}

LeaveDay.prototype.is_morning_leave = function() {
  return String(this.day_part) === String(leaveConstants.leave_day_part_morning())
}

LeaveDay.prototype.is_afternoon_leave = function() {
  return (
    String(this.day_part) === String(leaveConstants.leave_day_part_afternoon())
  )
}
...
LeaveDay.prototype.pretend_to_be_full_day = function() {
  return (this.day_part = leaveConstants.leave_day_part_all())
}
